    ...
    Item {
        ...
        Rectangle { id: body
            ...
            ListView { id: categoriesList
                ...
                delegate: MouseArea {
                    objectName: "ui--navigation:binding:level_2"
                    hoverEnabled: true
            ...
            StackView { id: outlet
                ...
                function parseRouteUIItems() {
                    // Clean all elements with navigation depth #3
                    BlackMesaUtils.clearTraversalTree([3]);
                    BlackMesaUtils.parseTraversalTree(outlet);
                    BlackMesaUtils.traversalDepth = 3;
