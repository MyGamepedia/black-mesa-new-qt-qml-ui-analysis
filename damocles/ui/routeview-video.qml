    ...
    OptionsList { id: videoOptions
        ...
        onRequestSettingsChange: {
            if (model.key === models.video_quality.key) {
                ...
                // just manually set
                setValue(models.video_quality, '4');
            }
        ...
        function setAdvancedSettingsState(settings) {
            var isCustom = models.video_quality.value === "4";
        ...
        model: ListModel { id: videoOptionsModel
            Component.onCompleted: {
                ...
                overallQualityOptions.push({ label: values.qualityCustom, value: "4" });
                append({
                ...
                if (unlocked) {
                    ...
                    lightsOptions.push({ label: values.qualityInsane2, value: "6", warning: 1 });
                }
                append({
                    //disabled: false,
