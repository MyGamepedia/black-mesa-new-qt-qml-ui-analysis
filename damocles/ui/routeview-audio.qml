            ...
            Component.onCompleted: {
                ...
                append({
                    ...
                    options: [
                        ...
                        // { label: values.langGreek, value: "ukrainian" },
                        { label: values.langHungarian, value: "hungarian" },
                        // { label: values.langIndonesian, value: "ukrainian" },
                        { label: values.langItalian, value: "italian" },
                        // { label: values.langJapanese, value: "ukrainian" },
                        { label: values.langKorean, value: "korean" },
                        // { label: values.langLithuanian, value: "ukrainian" },
