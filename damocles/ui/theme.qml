...
QtObject {
    ...
    readonly property QtObject colors: QtObject {
        readonly property color highlight: "#4aceff"
    ...
    readonly property QtObject sounds: QtObject {
        ...
        readonly property string music1: "#ui/gamestartup_1.ogg" // make sure to add leading '#' in front of ambient (music) file name. (cf. CHAR_DRYMIX in snd_dma.cpp)
        readonly property string music2: "#ui/gamestartup_2.ogg" //
    }
