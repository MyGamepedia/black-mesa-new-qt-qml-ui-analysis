...
Item { id: header
    ...
    property int headerMargin: Math.ceil(32 * Theme.widthScale)
    ...
    Item { id: subNavContainer
        ...
        ListView {
            ...
            delegate: LetterboxButton {
                objectName: "ui--navigation:button:level_1"
                disabled: !isEnabled
                text: label
