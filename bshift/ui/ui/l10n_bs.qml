    ...
    function _getStringMap() {
        return Object.freeze({
            ...
            credits: Object.freeze({
                ...
                benDescr: getString("#BSQTUI_Credits_Ben_Descr"),
				skwallieDescr: getString("#BSQTUI_Credits_Skwallie_Descr"),
                ...
                guestCompDescr: getString("#BSQTUI_Credits_guestComp_Descr"),
            ...
            buttons: Object.freeze({
                ...
                controllerBindings: getString("#BSQTUI_Header_Options_Controller"),
            ...
            options: Object.freeze({
                bindings: Object.freeze({
                    ...
                    zoom: getString("#BSQTUI_Option_Binding_Zoom"),
