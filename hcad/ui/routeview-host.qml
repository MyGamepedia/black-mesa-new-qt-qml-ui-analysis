...
RouteView {
    ...
    property int optionHeight: Math.ceil(72 * Theme.heightScale)
            ...
            Item { id: mapContainer
                ...
                OptionsListRow { id: map
                    ...
                    model: ListElement { id: mapModel
                        ...
                        property string value: "dm_stalkyard" //def value

						//List of maps can be used. Removing it will make option list empty and useless.
