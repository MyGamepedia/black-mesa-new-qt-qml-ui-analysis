...
Item { id: editorRoot  
    ...
    function loadAllFromCvars() {  
        ...
        param1Field.text = (pp[0] || "1.0");  
        param2Field.text = (pp[1] || "10");  
        param3Field.text = (pp[2] || "10");  
        param4Field.text = (pp[3] || "0");  
  
        // sizes  
        var sp = BlackMesaEngine.getConsoleVariableAsString("sv_hcad_mle_flare_sizes").split(" ");  
        size1Field.text = (sp[0] || "1.0");  
        size2Field.text = (sp[1] || "1.0");  
        size3Field.text = (sp[2] || "1.0");  
  
        // intensity  
        var ip = BlackMesaEngine.getConsoleVariableAsString("sv_hcad_mle_flare_intensity").split(" ");  
        int1Field.text = (ip[0] || "1.0");  
        int2Field.text = (ip[1] || "1.0");  
        int3Field.text = (ip[2] || "1.0");  
        ...
        // attenuation  
        attenuationField.text = BlackMesaEngine.getConsoleVariableAsString("sv_hcad_mle_flare_attenuation");  
        ...
        // glow proxy size  
        gpzField.text = BlackMesaEngine.getConsoleVariableAsString("sv_hcad_mle_flare_gpz");  
  
        // angles  
        var ap = BlackMesaEngine.getConsoleVariableAsString("sv_hcad_mle_flare_angles").split(" ");  
        ang1Field.text = (ap[0] || "0");  
        ang2Field.text = (ap[1] || "0");  
        ang3Field.text = (ap[2] || "0");  
    ...
    Item { id: flaresOverlay  
        ...
        function updateFlares() {  
            // 1. Ask the plugin to refresh maxents + eye pos/ang  
        ...
        Repeater {  
            ...
            delegate: Item {  
                ...
                visible: model.entIndex !== editorRoot.flareIndex  
                ...
                Rectangle {  
                    ...
                    width: 4; height: 4  
                    radius: 2  
                    color: circleMouseArea.containsMouse ? "white" : Theme.colors.highlight
                }  
