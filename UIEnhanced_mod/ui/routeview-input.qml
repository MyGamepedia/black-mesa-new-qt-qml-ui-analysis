    ...
    Item { id: container
        ...
        OptionsList { id: inputOptions
            ...
            onRequestSettingsChange: {
                if (model.key === models.mouse_accelerationswitch.key) {
                    setAccelerationState();
                }
            }
            ...
            function setAccelerationState() {
                models.mouse_acceleration.disabled = models.mouse_accelerationswitch.value === "0"
            }
