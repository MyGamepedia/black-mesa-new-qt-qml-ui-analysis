...
BindingList {
    commands: [
        ...
        InputBindingsManager.getBindingComponentConfig('+zoom'),
        ...
        InputBindingsManager.getBindingComponentConfig('+quicktripmine'),
        ...
        InputBindingsManager.getBindingComponentConfig('slot6')
    ]
}
