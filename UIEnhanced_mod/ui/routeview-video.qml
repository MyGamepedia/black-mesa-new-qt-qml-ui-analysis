    ...
    OptionsList { id: videoOptions
        ...
        Component.onCompleted: {
            qualitySettings = {
                "0": { // POTATO
                    ...
                    video_modelDetail: "2", // Low
                    video_modelDetailFx: "0",
                    video_textureDetail: "2", // Low
                    video_filtering: "bilinear",
                    video_motionBlur: "0", // OFF
                    video_waterDetail: "simple",
                    video_csmQuality: "0", // Potato
                ...
                "2": { // MEDIUM
                    ...
                    video_modelDetail: "1", // Medium
                    video_modelDetailFx: "1",
                    video_textureDetail: "1", // Medium
                    video_filtering: "trilinear",
                    video_motionBlur: "1", // ON
                    video_waterDetail: "world",
                    video_csmQuality: "1", // Low
                    video_csmMemory: "1", // Medium
                ...
                "3": { // HIGH
                    ...
                    video_modelDetailFx: "1",
                    video_textureDetail: "0", // High
                    video_filtering: "4",
                    video_motionBlur: "1", // ON
                    video_waterDetail: "world",
                    video_csmQuality: "2", // High
                ...
                "4": { // Ultra
                    ...
                    video_csmQuality: "3", // Ultra
                    video_csmMemory: "2", // High
                    video_dynamicShadowQuality: "4", // High
                    video_dynamicShadowMemory: "0", // High
                    video_dynamicShadowSoftness: "2", // High
                    video_dynamicLightsQuality: "4", // Ultra
                    video_godRays: "2", // High
                    video_lensFlare: "1",
                    video_chromaticAberration: "1",
                    video_radioactiveNoise: "1",
        ...
        readonly property QtObject groups: QtObject {
            function displayMode() {
                ...
                videoOptions.hasPendingVideoReload = true;
        ...
        readonly property QtObject setComplex: QtObject {
            function video_vsync(value) {
                BlackMesaEngine.setConsoleVariableAsInt("mat_vsync", value);
                videoOptions.hasPendingVideoReload = true;
            }

            function video_modelDetail(value) {
                BlackMesaEngine.setConsoleVariableAsInt("r_rootlod", value);
                videoOptions.hasPendingVideoReload = true;
            }

            function video_textureDetail(value) {
                BlackMesaEngine.setConsoleVariableAsInt("mat_picmip", value);
                videoOptions.hasPendingVideoReload = true;
            }
        ...
        readonly property QtObject getComplex: QtObject {
            function video_vsync() {
                var that = BlackMesaEngine.getConsoleVariableAsInt("mat_vsync");
                return that.toString();
            }

            function video_modelDetail() {
                var that = BlackMesaEngine.getConsoleVariableAsInt("r_rootlod");
                return that.toString();
            }

            function video_textureDetail() {
                var that = BlackMesaEngine.getConsoleVariableAsInt("mat_picmip");
                return that.toString();
            }
        ...
        model: ListModel { id: videoOptionsModel
            Component.onCompleted: {
                ...
                // Color Correction
                append({
                    label: labels.video_colorcorrection,
                    type: "select",
                    valueType: "int",
                    value: "",
                    key: "video_colorcorrection",
                    cvar: "mat_colorcorrection",
                    options: [
                        { label: values.off, value: "0" },
                        { label: values.on, value: "1" }
                    ],
                    description_main: labels.video_desc_help_COLORCORRECTION
                });
                ...
                append({
                    //disabled: false,
                    label: labels.video_modelDetailFx,
                    type: "select",
                    valueType: "int",
                    value: "",
                    key: "video_modelDetailFx",
                    cvar: "cl_mdldetailfx_enable",
                    options: [
                        { label: values.off, value: "0" },
                        { label: values.on, value: "1" }
                    ],
                    description_main: labels.video_desc_help_BLOODACIDWEAPONS
                });
                ...
                append({
                    ...
                    description_main: BlackMesaEngine.getLocalizedString("#QTUI_Option_Video_Desc_Help_ANTIALIASING"),
                    usage_cpu: labels.video_desc_usage_minor,
                ...
                append({
                    ...
                    description_main: BlackMesaEngine.getLocalizedString("#QTUI_Option_Video_Desc_Help_GODRAYS"),
                    usage_cpu: labels.video_desc_usage_moderate,
                    usage_gpu: labels.video_desc_usage_moderate,
                    usage_ram: labels.video_desc_usage_minor
                });
        ...
        buttons: VisualItemModel { id: buttons
            CTAButton {
                ...
                onClicked: {
                    ...
                    // prevent calling `savereloadaftersettingschange` twice, already called in ui/component-optionslist.qml
                }
            }
