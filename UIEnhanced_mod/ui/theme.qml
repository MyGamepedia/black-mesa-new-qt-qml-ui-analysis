...
QtObject {
    ...
    readonly property QtObject colors: QtObject {
        ...
        readonly property color navigationHighlight: "#e88849" 
    }
    ...
    readonly property QtObject fonts: QtObject {
        ...
        readonly property string light: [_loaders.notoSansCJKLight.name, _loaders.notoSansLight.name].join(", ")
        readonly property string bold: [_loaders.notoSansCJKBold.name, _loaders.notoSansBold.name].join(", ")
        readonly property string regular: [_loaders.notoSansCJKRegular.name, _loaders.notoSansRegular.name].join(", ")
    }
