...
RouteView {
    property int headerHeight: Math.ceil(80 * Theme.widthScale)
    property int headerMargin: Math.ceil(16 * Theme.widthScale)
    property int headerFontSize: Math.ceil(32 * Theme.heightScale)
    property int optionHeight: Math.ceil(64 * Theme.heightScale)
    ...
    Item {
        width: Math.ceil(1024 * Theme.widthScale)
        height: Math.ceil(768 * Theme.heightScale)
        ...
        Item { id: contents
            ...
            Item { id: serverNameContainer
                ...
                OptionsListRow { id: serverName
                    ...
                    model: ListElement { id: serverNameModel
                        ...
                        property string value: BlackMesaEngine.getConsoleVariableAsString("hostname")
                    }
            ...
            Item { id: mapContainer
                ...
                OptionsListRow { id: map
                    ...
                    model: ListElement { id: mapModel
                        ...
                        property string value: "dm_stalkyard"
            ...
            Item { id: fragLimitContainer
                ...
                OptionsListRow { id: fragLimit
                    ...
                    model: ListElement { id: fragLimitModel
                        ...
                        property string type: "text"
                        property real value: BlackMesaEngine.getConsoleVariableAsInt("mp_fraglimit")
                    }
                    onRequestSettingsChange: handleSettingsChange
                }
            }
            ...
            Item { id: timeLimitContainer
                ...
                OptionsListRow { id: timeLimit
                    ...
                    model: ListElement { id: timeLimitModel
                        ...
                        property string type: "text"
                        property real value: BlackMesaEngine.getConsoleVariableAsInt("mp_timelimit") / 60
                    }
                    onRequestSettingsChange: handleSettingsChange
                }
            }

            Item { id: warmupContainer
                anchors.top: timeLimitContainer.bottom
                width: parent.width
                height: optionHeight

                OptionsListRow { id: warmup
                    anchors.top: parent.top
                    model: ListElement { id: warmupModel
                        property string label: BlackMesaEngine.getLocalizedString("#BlackMesaUI_Multiplayer_Warmup")
                        property string type: "text"
                        property real value: BlackMesaEngine.getConsoleVariableAsInt("mp_warmup_time")
                    }
                    onRequestSettingsChange: handleSettingsChange
                }
            }
            ...
            Item { id: teamPlayContainer
                anchors.top: warmupContainer.bottom
                width: parent.width
                height: optionHeight
                ...
                OptionsListRow { id: teams
                    ...
                    model: ListElement { id: teamsModel
                        ...
                        property string value: BlackMesaEngine.getConsoleVariableAsBoolean("mp_teamplay")
                    }
                    onRequestSettingsChange: handleSettingsChange
                }
            }
            ...
            Item { id: respawnContainer
                ...
                OptionsListRow { id: respawn
                    ...
                    model: ListElement { id: respawnModel
                        ...
                        property string type: "checkbox"
                        property string value: BlackMesaEngine.getConsoleVariableAsBoolean("mp_forcerespawn")
                    }
                    onRequestSettingsChange: handleSettingsChange
                }
            }
            ...
            Timer {
                ...
                onTriggered: {
                    if (!BlackMesaEngine.isInGame()) {
                        ...
                        BlackMesaEngine.setConsoleVariableAsInt("mp_timelimit", timeLimitModel.value * 60)
                        ...
                        BlackMesaEngine.setConsoleVariableAsInt("mp_warmup_time", warmupModel.value)
                        ...
                        BlackMesaEngine.writeHostMultiplayerSettings();
                    }
                }
            }
